...
print(Fore.RED +"-> Luckily, this tool also provides backup option::You can restore the changes by responding '2' when")
...
if (choice == '1'): # means user want to escalate prevlidge of specified account
	...
	print(Fore.YELLOW+"		|**********************************************| \n\n")
	print("\n\n	 >>>>>>>>>>> Your victim password is same as yours :)  <<<<<<<<<<< \n")
...
if (choice == '2'):
   ...
   print("\n\n\n")
   print(Fore.YELLOW +"		|**********************************************|")
   print(Fore.YELLOW+"           	|	Password restored Successfully!!       |")
   print(Fore.YELLOW+"		|**********************************************| \n\n")
   exit()

else:
   print(" \n\n\n You entered Wrong input: Please Re-run program and enter '1' and '2' only.")
